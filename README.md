...
```bash
# Install the SDK - dependencies will be auto-installed
...
The SDK will automatically install required dependencies (`@livekit/react-native`, `@livekit/react-native-webrtc`, `livekit-client`) during installation.
